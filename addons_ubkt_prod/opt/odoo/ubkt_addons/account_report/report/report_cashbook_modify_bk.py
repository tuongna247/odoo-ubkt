...
class ReportCashBook(models.AbstractModel):
    ...
    def _get_account_move_entry(self, accounts, init_balance, sortby, display_account):
        ...
        sql = ('''SELECT l.id AS lid, l.account_id AS account_id, l.date AS ldate, j.code AS lcode, l.payment_id as lpayment, l.currency_id, l.amount_currency, l.ref AS lref, l.name AS lname, COALESCE(l.debit,0) AS debit, COALESCE(l.credit,0) AS credit, COALESCE(SUM(l.debit),0) - COALESCE(SUM(l.credit), 0) AS balance,\
        ...
        for account in accounts:
                ...
                if line['lpayment']:
                    ...
                    if payment and (payment.is_advance is True or payment.is_internal_transfer is True):
                        if payment.is_advance is True:
                            ...
                            if payment.is_internal_transfer is False:
                        ...
                        if payment.is_internal_transfer is True:
                            line['lpayment_is_internal_transfer'] = 1
                            if payment.is_advance is False:
            ...
            res['l_toatl_1'] = l_toatl_1
            res['l_toatl_2'] = l_toatl_2
            res['l_toatl_3'] = l_toatl_3
            res['l_toatl_4'] = l_toatl_4
            res['l_toatl_5'] = l_toatl_5
            res['l_toatl_6'] = l_toatl_6
